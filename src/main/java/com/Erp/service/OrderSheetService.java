...
import com.Erp.dto.OrderSheetAddmDto;
import com.Erp.dto.OrderSheetDetailAddmDto;
import com.Erp.dto.OrderSheetFormDto;
import com.Erp.entity.*;
import com.Erp.repository.OrderSheetDetailRepository;
import com.Erp.repository.OrderSheetRepository;
...
public class OrderSheetService {
    ...
    //주문서를 필터하여 조회합니다.
    public List<OrderSheetFormDto> orderSheetListFilter(String filter) {
        List<OrderSheet> buyOrderSheets = orderSheetRepository.findBuyOrderSheetFilter(DivisionStatus.valueOf(filter));
        List<OrderSheetFormDto> orderSheetFormDtos = new ArrayList<OrderSheetFormDto>();
        for (OrderSheet orderSheet : buyOrderSheets){
            OrderSheetFormDto dto = OrderSheetFormDto.of(orderSheet);
            orderSheetFormDtos.add(dto);
