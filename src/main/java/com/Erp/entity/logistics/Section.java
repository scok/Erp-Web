...
public class Section extends DistributionEntity{
    ...
    // Section 엔터티 필드값 저장
    public static Section createSection(SectionAddDto sectionAddDto, String strNowDate, int count,String memberName){
        ...
        section.setSecAddress(sectionAddDto.getSecAddress() +" "+sectionAddDto.getSecAddressDetail());
        section.setPageYandN("Y");
        section.setCreateName(memberName);
