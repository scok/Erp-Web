...
import com.Erp.service.OrderSheetService;
...
public class OrderSheetController {
    ...
    public @ResponseBody Object OrderSheetSelectFilter(@RequestBody String filter) {

        filter = filter.substring(1,filter.length()-1);
        System.out.println(filter);

        List<OrderSheetFormDto> orderSheetFormDtos = orderSheetService.orderSheetListFilter(filter);
